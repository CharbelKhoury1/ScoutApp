...
<script>
  ...
  function confirmAction() {
    ...
    if (result) {
      window.location.href = "../ControlRequest/updateGenCom.php";
    } else {
...
<script>
    function confirmReject() {
      ...
      if (resultRej) {
        window.location.href = "../ControlRequest/updateRejGenCom.php";
      } else {
        alert("Action cancelled!");
      }
    }
...
<tbody>
    ...
    <a href="controlReqGenCom.php" class="icon-link">

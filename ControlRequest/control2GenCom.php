...
<script>
  ...
  function cancelAction() {
    ...
    if (result) {
      window.location.href = "../ControlRequest/requests_rejected_GenCom.php";
    } else {
...
<script>
    function confirmAction() {
      ...
      if (resultRej) {
        window.location.href = "../ControlRequest/update2GenCom.php";
      } else {
        alert("Action cancelled!");
      }
    }
...
<tbody>
    ...
    <a href="requests_rejected_GenCom.php" class="icon-link">
    ...
    <div class="container3">
      <div class="center1">
        ...
        <button class="red-button" onclick="cancelAction()">Cancel</button>
      </div>
    </div>
